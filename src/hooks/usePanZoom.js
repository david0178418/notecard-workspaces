...
export function usePanZoom({ initialViewState, containerRef }) {
    ...
    const handleTouchMove = useCallback((event) => {
        if (!isPanning.current || touchIdentifier.current === null)
            return;
    ...
    const handleTouchEndOrCancel = useCallback((event) => {
